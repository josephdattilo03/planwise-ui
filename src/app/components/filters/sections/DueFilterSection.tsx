        ...
        <div>
            <FilterSection title="Due Date">
                <div className='flex flex-col gap-1'>
                    ...
                    <p className="text-chip-info">{t("from-filter-title")}</p>
                    <DatePicker value={selectedDueDateRange.startDate} onChange={(newStartDate) => {
                        toggleDateRange({
                            ...selectedDueDateRange,
                            startDate: newStartDate
                        })
                    }} />
                    <p className="text-chip-info">{t("to-filter-title")}</p>
                    <DatePicker value={selectedDueDateRange.endDate} onChange={(newEndDate) => {
                        toggleDateRange({
                            ...selectedDueDateRange,
                            endDate: newEndDate
                        })
