...
export default function TaskCard({task}: TaskCardProps) {
    ...
    return (
        <div className='flex flex-col gap-2 border border-(--task-stroke) rounded-2xl p-3'>
            <div>
            ...
            <div>
                <div className='flex flex-row gap-3 items-center text-nowrap'>
                    ...
                    <p className="text-label text-(--task-date-due-text)">Due: {task.dueDate.toLocaleDateString("en", {
                        month: "short",
                        day: "numeric"
                    })}</p>
